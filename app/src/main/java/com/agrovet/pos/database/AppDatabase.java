...
@Database(entities = {Cliente.class, Producto.class, Proveedor.class, Venta.class, VentaItem.class, Movimiento.class, Abono.class}, version = 15, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract VentaItemDao ventaItemDao();
            ...
            synchronized (AppDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                                    AppDatabase.class, "Agrovet_Hybrid.db")
